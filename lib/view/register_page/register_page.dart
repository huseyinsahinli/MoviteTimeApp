...
import 'package:firebase_islemleri/core/widgets/show_dialog.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  Timer _timer = Timer(const Duration(seconds: 3), () => print('done'));
                            ...
                            if (_email.text.isNotEmpty &&
                              ...
                              if (_password.text.toString() ==
                                ...
                                try {
                                  ...
                                  await CustomAlertDialogBox.getAlertDialog(
                                      context,
                                      CustomAlertDialogBox.successfulAlertBox(
                                  ...
                                  CustomAlertDialogBox.getAlertDialog(
                                      context,
                                      CustomAlertDialogBox.warningAlertBox(
                                        e.message.toString(),
                                      ),
                                      _timer);
                                }
